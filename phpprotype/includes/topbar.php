    ...
    <div class="navbar-right">
        ...
        <div class="user-profile-menu" id="user-profile-btn">
            ...
            <div class="user-dropdown" id="user-dropdown">
                <a href="company-settings.php" class="user-dropdown-item"><i class="fa-solid fa-user-gear"></i> Profile & Settings</a>
                <a href="access-level.php" class="user-dropdown-item"><i class="fa-solid fa-shield-halved"></i> Access Levels</a>
                <div class="user-dropdown-divider"></div>
                <div class="user-dropdown-item" onclick="App.logout()"><i class="fa-solid fa-right-from-bracket" style="color: var(--status-danger);"></i> Logout</div>
            </div>
        </div>
    </div>
</header>
