        ...
        * {
        ...
        .login-hero {
            ...
            background: 
                ...
                url('assets/images/herbal_bg.jpg') center/cover no-repeat;
            padding: 3.5rem 3rem;
            display: flex;
            ...
            <div class="hero-top">
                <div class="brand-badge-container">
                    <div class="brand-logo-wrap">
                        <img src="assets/images/logo.png" alt="Vikas Udhyog Logo">
                    </div>
                    <div>
                ...
                <form id="login-form" action="index.php" method="POST">
                    <div class="input-group-custom">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="username" id="username" class="input-field" placeholder="e.g. admin or admin@vikasudhyog.com" value="admin" required autofocus>
