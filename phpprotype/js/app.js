...
const VIEW_ROUTES = {
    'dashboard': 'index.php',
    'master-company': 'company-master.php',
    'master-user': 'user-master.php',
    'master-access': 'access-level.php',
    'master-vendor': 'vendor-master.php',
    'master-customer': 'customer-master.php',
    'master-broker': 'broker-master.php',
    'master-item': 'item-master.php',
    'master-unit': 'unit-master.php',
    'master-account': 'account-master.php',
    'txn-purchase': 'purchase-entry.php',
    'txn-wb-purchase': 'wb-purchase-entry.php',
    'txn-sales-order': 'sales-entry.php',
    'txn-wb-sales': 'wb-sales-entry.php',
    'txn-order-dispatch': 'order-dispatch.php',
    'txn-sales-invoice': 'sales-purchase-order.php',
    'txn-receipt': 'receipt-voucher.php',
    'txn-payment': 'payment-voucher.php',
    'inv-overview': 'stock-overview.php',
    'inv-ledger': 'item-ledger.php',
    'inv-adjustment': 'stock-adjustment.php',
    'inv-low-stock': 'low-stock-alert.php',
    'rpt-purchase': 'purchase-report.php',
    'rpt-sales': 'sales-report.php',
    'rpt-order': 'order-report.php',
    'rpt-cash-reg': 'cash-bank-register.php',
    'set-company': 'company-settings.php',
    'set-whatsapp': 'whatsapp-settings.php',
    'set-backup': 'backup-restore.php'
};
