...
<head>
    ...
    <style>
        ...
        .login-left {
            flex: 1.1;
            background: linear-gradient(135deg, rgba(24, 58, 29, 0.92) 0%, rgba(107, 142, 35, 0.88) 100%), url('{{ asset('admin/images/herbal_bg.jpg') }}') center/cover;
            padding: 3.5rem 3rem;
            display: flex;
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            <div class="login-brand-header">
                <img src="{{ asset('admin/images/logo.png') }}" alt="Vikas Udhyog Logo" class="login-brand-logo">
                <div>
        ...
        <div class="login-right">
            ...
            @if(session('error'))
                <div class="error-alert">
                    <i class="fa-solid fa-circle-exclamation" style="margin-right: 0.4rem;"></i> {{ session('error') }}
                </div>
            @endif
            ...
            <form id="login-form" action="{{ route('admin.login.post') }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom: 1.25rem;">
                    ...
                    <div style="position: relative;">
                        <input type="text" name="username" id="username" class="form-control" placeholder="Enter username or email" value="{{ old('username', 'admin') }}" required style="padding-left: 2.5rem;">
                ...
                <div class="form-group" style="margin-bottom: 1.25rem;">
                    ...
                    <div style="position: relative;">
                        <input type="password" name="password" id="password" class="form-control" placeholder="Enter password" value="admin123" required style="padding-left: 2.5rem;">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.75rem; font-size: 0.85rem;">
                    <label style="display: flex; align-items: center; gap: 0.4rem; cursor: pointer; color: #4B5563;">
                        <input type="checkbox" name="remember" checked style="accent-color: #6B8E23;"> Remember Me
                    </label>
