...
@section('content')
<section class="view-section active" id="view-company-edit">
    <!-- Breadcrumb & Top Bar -->
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="font-size: 0.8rem; color: var(--text-muted); margin-bottom: 0.25rem; display: flex; align-items: center; gap: 0.5rem;">
                ...
                <i class="fa-solid fa-chevron-right" style="font-size: 0.65rem;"></i>
                <span style="color: var(--primary); font-weight: 600;">Edit {{ $company->name }}</span>
            </div>
            <h1 class="page-title" style="margin: 0; font-size: 1.6rem; font-weight: 800; color: var(--text-primary); display: flex; align-items: center; gap: 0.6rem;">
                <i class="fa-solid fa-pen-to-square" style="color: var(--primary);"></i> Edit Company: {{ $company->name }}
            </h1>
            <p class="page-subtitle" style="margin: 0.2rem 0 0; color: var(--text-muted); font-size: 0.88rem;">
                Update corporate profile details, tax numbers, and bank settlement configurations.
            </p>
        </div>
    ...
    <div class="card" style="border-radius: 18px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.05); overflow: hidden;">
        <form action="{{ route('admin.masters.company.update', $company->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div style="padding: 2rem;">
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                        <div style="grid-column: span 2;">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="e.g. Vikas Udhyog" value="{{ old('name', $company->name) }}" required autofocus>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="code" class="form-control" placeholder="e.g. VU-SOJAT" value="{{ old('code', $company->code) }}">
                        </div>
                        ...
                        <div style="grid-column: span 2;">
                            ...
                            <input type="text" name="tagline" class="form-control" placeholder="e.g. Premium Sojat Henna Powder & Herbal Formulations Manufacturer" value="{{ old('tagline', $company->tagline) }}">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                        <div>
                            ...
                            <input type="text" name="gstin" class="form-control" placeholder="08AABCV1234F1Z5" maxlength="20" style="text-transform: uppercase;" value="{{ old('gstin', $company->gstin) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="pan" class="form-control" placeholder="AABCV1234F" maxlength="15" style="text-transform: uppercase;" value="{{ old('pan', $company->pan) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="financial_year" class="form-control" placeholder="2026-2027" value="{{ old('financial_year', $company->financial_year) }}">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" class="form-control" placeholder="info@vikasudhyog.com" value="{{ old('email', $company->email) }}">
                        </div>
                        ...
                        <div style="grid-column: span 3;">
                            ...
                            <textarea name="address" rows="2" class="form-control" placeholder="Plot No. 12-15, Industrial Area, Near Krishi Mandi">{{ old('address', $company->address) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="city" class="form-control" placeholder="Sojat City" value="{{ old('city', $company->city) }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="pincode" class="form-control" placeholder="306104" value="{{ old('pincode', $company->pincode) }}">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                        <div>
                            ...
                            <input type="text" name="bank_name" class="form-control" placeholder="State Bank of India" value="{{ old('bank_name', $company->bank_name) }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="bank_ifsc" class="form-control" placeholder="SBIN0031204" style="text-transform: uppercase;" value="{{ old('bank_ifsc', $company->bank_ifsc) }}">
                        </div>
                ...
                <div style="padding: 1.25rem; background: var(--bg-hover); border-radius: 12px; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.85rem; border: 1px solid var(--border-color);">
                    <input type="checkbox" name="is_default" id="comp-is-default" value="1" {{ old('is_default', $company->is_default) ? 'checked' : '' }} style="width: 20px; height: 20px; accent-color: var(--primary); cursor: pointer;">
                    <div>
