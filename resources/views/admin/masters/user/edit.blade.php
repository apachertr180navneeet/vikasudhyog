    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.75rem; flex-wrap: wrap; gap: 1rem;">
        <div>
            <div style="font-size: 0.8rem; color: var(--text-muted); margin-bottom: 0.35rem; display: flex; align-items: center; gap: 0.5rem;">
                ...
                <i class="fa-solid fa-chevron-right" style="font-size: 0.65rem;"></i>
                <span style="color: var(--primary); font-weight: 600;">Edit User</span>
            </div>
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem;">
            <a href="{{ route('admin.masters.user.show', $user) }}" class="btn btn-outline" style="border-radius: 10px; height: 42px; padding: 0 1.25rem; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem;">
    ...
    <form action="{{ route('admin.masters.user.update', $user) }}" method="POST" id="user-edit-form">
        ...
        <div class="form-grid-layout" style="display: grid; grid-template-columns: 1fr 340px; gap: 1.5rem; align-items: start;">
                    ...
                    <div style="padding: 1.5rem; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.25rem;">
                        <div class="form-group" style="grid-column: 1 / -1;">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="text" name="name" id="field-name" class="form-control" placeholder="e.g. Navneet Sharma" value="{{ old('name', $user->name) }}" required style="padding-left: 2.5rem; height: 42px; border-radius: 8px;" oninput="updateLivePreview()">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="email" name="email" id="field-email" class="form-control" placeholder="e.g. navneet@vikasudhyog.com" value="{{ old('email', $user->email) }}" required style="padding-left: 2.5rem; height: 42px; border-radius: 8px;" oninput="updateLivePreview()">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="text" name="phone" id="field-phone" class="form-control" placeholder="e.g. +91 98290 12345" value="{{ old('phone', $user->phone) }}" style="padding-left: 2.5rem; height: 42px; border-radius: 8px;" oninput="updateLivePreview()">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="box-shadow: 0 4px 16px rgba(0, 0, 0, 0.04); border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color);">
                    <div style="padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--border-color); background: #FCFDFB; display: flex; align-items: center; justify-content: space-between;">
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            ...
                            <div>
                                <h3 style="margin: 0; font-size: 1.05rem; font-weight: 700; color: var(--text-primary);">2. Login Credentials &amp; Password Update</h3>
                                <p style="margin: 0.15rem 0 0; font-size: 0.8rem; color: var(--text-muted);">Username handle and optional password reset</p>
                            </div>
                        </div>
                    ...
                    <div style="padding: 1.5rem; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.25rem;">
                        <div class="form-group" style="grid-column: 1 / -1;">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="text" name="username" id="field-username" class="form-control" placeholder="e.g. navneet" value="{{ old('username', $user->username) }}" required style="padding-left: 2.5rem; height: 42px; border-radius: 8px; font-family: monospace;" oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9_.-]/g, ''); updateLivePreview();">
                            </div>
                        </div>

                        <!-- Password -->
                        <div class="form-group">
                            <label class="form-label" style="font-weight: 600; font-size: 0.88rem; margin-bottom: 0.4rem; display: flex; justify-content: space-between; align-items: center;">
                                <span>New Password</span>
                                <span style="font-size: 0.72rem; color: #64748B; font-weight: normal;">(Leave empty to keep current)</span>
                            </label>
                            <div style="position: relative;">
                                ...
                                <input type="password" name="password" id="field-password" class="form-control" placeholder="Leave blank to keep unchanged" style="padding-left: 2.5rem; padding-right: 2.5rem; height: 42px; border-radius: 8px;" oninput="checkPasswordStrength(this.value)">
                            ...
                            <div style="margin-top: 0.4rem;">
                                ...
                                <span id="pwd-strength-text" style="font-size: 0.72rem; color: var(--text-muted); margin-top: 0.2rem; display: block;">Only fill if changing password</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="password" name="password_confirmation" id="field-password-confirm" class="form-control" placeholder="Re-enter new password" style="padding-left: 2.5rem; padding-right: 2.5rem; height: 42px; border-radius: 8px;">
            ...
            <div class="form-sidebar-col" style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div class="card" style="box-shadow: 0 4px 16px rgba(0, 0, 0, 0.04); border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color); text-align: center;">
                    ...
                    <div style="padding: 1.5rem 1.25rem;">
                        ...
                        <div id="preview-company" style="font-size: 0.78rem; color: var(--text-muted); margin-top: 0.85rem; padding-top: 0.75rem; border-top: 1px dashed var(--border-color); display: flex; align-items: center; justify-content: center; gap: 0.35rem;">
                            @if($user->company)
                                <i class="fa-solid fa-building" style="color: var(--primary);"></i> {{ $user->company->name }}
                            @else
                ...
                <div class="card" style="box-shadow: 0 4px 16px rgba(0, 0, 0, 0.04); border-radius: 16px; overflow: hidden; border: 1px solid var(--border-color); padding: 1.25rem; font-size: 0.8rem;">
                    <div style="font-weight: 700; color: var(--text-primary); margin-bottom: 0.75rem; font-size: 0.88rem; display: flex; align-items: center; gap: 0.4rem;">
                        <i class="fa-solid fa-clock-rotate-left" style="color: var(--primary);"></i> Audit Trail
                    </div>
                    <div style="display: flex; flex-direction: column; gap: 0.5rem; color: #64748B;">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <strong style="color: var(--text-primary);">{{ $user->last_login_at ? $user->last_login_at->format('d M Y, h:i A') : 'Never' }}</strong>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                ...
                @if(auth()->id() !== $user->id)
                    <div style="background: #FEF2F2; border: 1px solid #FECACA; border-radius: 12px; padding: 1.25rem;">
                        <div style="font-weight: 700; color: #991B1B; margin-bottom: 0.35rem; display: flex; align-items: center; gap: 0.4rem; font-size: 0.88rem;">
                            <i class="fa-solid fa-triangle-exclamation"></i> Danger Zone
                        </div>
                        <p style="font-size: 0.78rem; color: #7F1D1D; margin: 0 0 0.85rem;">Soft deletes this user account and immediately prevents login.</p>
                        <button type="button" class="btn" style="background: #DC2626; color: #FFFFFF; font-weight: 700; font-size: 0.82rem; border-radius: 8px; width: 100%; height: 38px;" onclick="confirmDeleteUser({{ $user->id }}, '{{ addslashes($user->name) }}', '{{ $user->username }}')">
